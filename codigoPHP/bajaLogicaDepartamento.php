...
if (isset($_GET['codigo'])) {
    ...
    try {
        $sqlDepartamento = "UPDATE Departamento SET FechaBaja = now() WHERE CodDepartamento = :codDept;"; //Los : que van delante, es para indicar que sera una consulta preparada
